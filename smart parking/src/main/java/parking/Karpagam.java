 ...
 */
@WebServlet("/Karpagam")
public class Karpagam extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		final String INSERT_QUERY ="insert into smartparkingsystem.karpagam(location,name,Hours,vehicletype,VehicleNumber,phonenumber,slotno) values(?,?,?,?,?,?,?)";
		try {
			...
			if(Status!=0) {
				final String UPDATE_QUERY ="update Smartparkingsystem.Slotkarpagam set Status=1 where Slots=?";
