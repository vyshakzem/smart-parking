 ...
 */
@WebServlet("/ParkingSlot4Servlet")
public class ParkingSlot4Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out=response.getWriter();
	     ...
	     ResultSet resultSet;
	     final String SELECT_QUERY = "SELECT * from SlotMalumichanpati";
	     out.println("<html>");
			...
			out.println("<div class=\"filters\">\r\n"
					...
					+ "  <button onclick=\"location.href='ParkingSlot1Servlet';\"class=\"filter-option\" data-filter=\"*\">OTHAKALMANDABAM</button>\r\n"
					+ "</div>");
			...
			try {
				...
				out.println("<form action=\"Booking3.jsp\" method =\"post\">\r\n"
						+ "<h1>Parking Slot</h1>\r\n"
				...
				while(resultSet.next()) {
					if(resultSet.getString("status").equals("0")) {
						...
						out.println(" <div class=\"parking-space free\">\r\n"
								+ "              <button onclick=\"location.href='Booking3.jsp';\" value ='"+slot+"'  name = \"slot\" >" + resultSet.getString("Slots") +"</button>\r\n"
								+ "              </div>");
					}
					else {
