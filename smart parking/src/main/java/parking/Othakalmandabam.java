 ...
 */
@WebServlet("/Othakalmandabam")
public class Othakalmandabam extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		final String INSERT_QUERY ="insert into Smartparkingsystem.othakalmandabam(location,name,Hours,vehicletype,VehicleNumber,phonenumber,slotno) values(?,?,?,?,?,?,?)";
		try {
			...
			if(Status!=0) {
				final String UPDATE_QUERY ="update Smartparkingsystem.SlotOthakalmandabam set Status=1 where Slotnumber=?";
