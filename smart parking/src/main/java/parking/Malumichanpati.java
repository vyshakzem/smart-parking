 ...
 */
@WebServlet("/Malumichanpati")
public class Malumichanpati extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		final String INSERT_QUERY ="insert into smartparkingsystem.malumichanpati(location,name,Hours,vehicletype,VehicleNumber,phonenumber,slotno) values(?,?,?,?,?,?,?)";
		try {
			...
			if(Status!=0) {
				final String UPDATE_QUERY ="update smartparkingsystem.slotmalumichanpati set Status=1 where Slots=?";
