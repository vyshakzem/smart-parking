 ...
 */
@WebServlet("/ParkingSlot2Servlet")
public class ParkingSlot2Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out=response.getWriter();
	     ...
	     ResultSet resultSet;
	     final String SELECT_QUERY = "SELECT * from slotgandhipuram";
	     out.println("<html>");
			...
			out.println("<div class=\"filters\">\r\n"
					+ "  <h3>LOCATION</h3>\r\n"
					+ "  <button onclick=\"location.href='ParkingSlot1Servlet';\" class=\"link\" data-filter=\"walks\">OTHAKALMANDABAM</button> \r\n"
			...
			try {
				...
				out.println("<form action=\"Booking1.jsp\" method =\"post\">\r\n"
						+ "<h1>Parking Slot</h1>\r\n"
				...
				while(resultSet.next()) {
					if(resultSet.getString("status").equals("0")) {
						...
						out.println(" <div class=\"parking-space free\">\r\n"
								+ "              <button onclick=\"location.href='Booking1.jsp';\" value ='"+slot+"'  name = \"slot\" >" + resultSet.getString("Slots") +"</button>\r\n"
								+ "              </div>");
					}
					else {
